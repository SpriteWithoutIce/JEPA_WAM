...
class ModelConfig(ChoiceRegistry):
    ...
    siglip_local_path: Optional[str] = None                 # Optional local checkpoint path/directory for SigLIP backbones
...
class ModelRegistry(Enum):
    ...
    PRISM_QWEN25_JEPASIGLIP_384PX_0_5B = Prism_Qwen25_0_5B_JEPASigLIP_384px
