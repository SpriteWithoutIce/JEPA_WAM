...
def detect_robot_platform():
    platform_override = os.environ.get("VLA_ROBOT_PLATFORM")
    if platform_override:
        platform_override = platform_override.upper()
        supported_platforms = {"LIBERO", "ALOHA", "BRIDGE", "CALVIN"}
        if platform_override not in supported_platforms:
            raise ValueError(
                f"Unsupported VLA_ROBOT_PLATFORM={platform_override!r}; "
