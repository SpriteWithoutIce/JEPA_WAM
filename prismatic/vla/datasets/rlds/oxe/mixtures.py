...
from prismatic.vla.datasets.rlds.oxe.robotwin_aloha import (
    ROBOTWIN_ALOHA_10_DATASETS,
    ROBOTWIN_ALOHA_CLEAN_50_DATASETS,
    ROBOTWIN_ALOHA_DATASETS,
)
...
OXE_NAMED_MIXTURES: Dict[str, List[Tuple[str, float]]] = {
    ...
    "aloha_robotwin_10": [(dataset_name, 1.0) for dataset_name in ROBOTWIN_ALOHA_10_DATASETS],
    "aloha_robotwin_clean_50": [(dataset_name, 1.0) for dataset_name in ROBOTWIN_ALOHA_CLEAN_50_DATASETS],
    "aloha_robotwin_all": [(dataset_name, 1.0) for dataset_name in ROBOTWIN_ALOHA_DATASETS],
# fmt: on
}
