...
def get_vision_backbone_and_transform(
    ...
    if vision_backbone_id in VISION_BACKBONES:
        ...
        if dino_local_path is not None and vision_cfg["cls"] in {
            DinoV2ViTBackbone,
            DinoSigLIPViTBackbone,
            DinoCLIPViTBackbone,
            JEPADinoViTBackbone,
        }:
            vision_kwargs["local_path" if vision_cfg["cls"] is DinoV2ViTBackbone else "dino_local_path"] = dino_local_path
        ...
        if siglip_local_path is not None and vision_cfg["cls"] is DinoSigLIPViTBackbone:
            vision_kwargs["siglip_local_path"] = siglip_local_path
