...
def build_vla_from_base_vlm(
    ...
    vlm = get_vlm(
        ...
        visual_token_cosine_use_projector_target=cfg.vla.visual_token_cosine_use_projector_target,
        visual_token_cosine_layer_idx=cfg.vla.visual_token_cosine_layer_idx,
        visual_token_cosine_projection_type=cfg.vla.visual_token_cosine_projection_type,
...
def train(cfg: TrainConfig) -> None:
    ...
    vla_dataset, action_tokenizer, collator = get_vla_dataset_and_collator(
        ...
        visual_token_cosine_target_future_only=cfg.vla.visual_token_cosine_target_future_only,
