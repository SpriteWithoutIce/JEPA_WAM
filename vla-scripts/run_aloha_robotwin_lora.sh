...
RUN_ID_NOTE="${RUN_ID_NOTE:-aloha-robotwin-50-lora-action-projector}"
mkdir -p "${LOG_DIR}"
...
PYTHON_BIN="${PYTHON_BIN:-/home/linyihan/jepa_copy/bin/python3.10}"
...

{
  ...
  echo "RLDS sources: rank-sharded across ${NUM_GPUS} processes"
