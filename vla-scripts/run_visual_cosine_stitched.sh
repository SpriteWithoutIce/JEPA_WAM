...
LOG_FILE="${LOG_DIR}/train_jepa_qwen25_visual_cosine_stitched_$(date +%Y%m%d_%H%M%S).log"
...
RUN_ID_NOTE="${RUN_ID_NOTE:-visual-cosine-qwen25-stitched}"
...
CMD=(
    ...
    --vla.stitch_primary_and_wrist_images True
