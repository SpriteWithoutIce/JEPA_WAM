...
echo "Evaluating LIBERO-plus rot6d checkpoint with action_head_type=${ACTION_HEAD_TYPE}, num_images_in_input=${NUM_IMAGES_IN_INPUT}, stitch_primary_and_wrist_images=${STITCH_PRIMARY_AND_WRIST_IMAGES}, trials=${TRIALS}, categories=${CATEGORY_FILTER}"
echo "Using CHECKPOINT=${CHECKPOINT}"
echo "Using LIBERO_PATH=${LIBERO_PATH}"
echo "Using LIBERO_CONFIG_PATH=${LIBERO_CONFIG_PATH}"
